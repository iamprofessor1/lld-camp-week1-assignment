...
class AudioPlayer : public IPlayPause, IDownload
{
    bool playing{false};
...
class CameraStreamPlayer : public IPlayPause, IStreamRecord
{
...
public:
    ...
    // void download(const string &) { throw logic_error("CameraStreamPlayer cannot download"); } // LSP break
    bool isPlaying() const { return playing; }
